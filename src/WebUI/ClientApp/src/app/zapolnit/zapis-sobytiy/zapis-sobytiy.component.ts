...
import { selectSelectedExecutionId } from '../spisok-kazney/spisok-kazney.selectors';
import { selectTapFormData, selectTaps, selectTapsList } from '../spisok-sobytiy/spisok-sobytiy.selectors';
import { CREATE_TAP_REQUEST, LOAD_TAP_FORM_DATA_REQUEST } from '../spisok-sobytiy/spisok-sobytiy.actions';
...
@Component({
  selector: 'app-zapis-sobytiy',
  templateUrl: './zapis-sobytiy.component.html',
  styleUrls: ['./zapis-sobytiy.component.css']
})
export class ZapisSobytiyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.store.select(selectTaps).subscribe((tapsState => {
      this.handleApiErrors(tapsState); // TODO: Handle errors properly
    }));
