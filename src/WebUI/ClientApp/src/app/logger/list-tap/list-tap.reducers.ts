import { CLEAR_TAPS, CLEAR_TAP_ERRORS, CREATE_TAP_FAIL, CREATE_TAP_REQUEST, DELETE_TAP_FAIL, DELETE_TAP_REQUEST, DELETE_TAP_SUCCESS, DESELECT_TAP, EDIT_TAP, LOAD_EXECUTION_TAPS_FAIL, LOAD_EXECUTION_TAPS_REQUEST, LOAD_EXECUTION_TAPS_SUCCESS, LOAD_TAP_FORM_DATA_FAIL, LOAD_TAP_FORM_DATA_REQUEST, LOAD_TAP_FORM_DATA_SUCCESS, SELECT_TAP, UPDATE_TAP_FAIL, UPDATE_TAP_REQUEST } from './list-tap.actions';
...
export const TapReducer = createReducer<TapsState>(
    initialState,
    ...
    on(CLEAR_TAP_ERRORS, (state) => ({ ...state, error: null })),
