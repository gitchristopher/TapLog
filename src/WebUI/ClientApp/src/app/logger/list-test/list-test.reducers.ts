import { LOAD_TESTS_FAIL, LOAD_TESTS_REQUEST, LOAD_TESTS_SUCCESS, SELECT_TEST, CREATE_TEST_REQUEST, CREATE_TEST_FAIL, DELETE_TEST_REQUEST, DELETE_TEST_SUCCESS, DELETE_TEST_FAIL, UPDATE_TEST_REQUEST, UPDATE_TEST_FAIL, DESELECT_TEST } from './list-test.actions';
...
export const TestReducer = createReducer<TestsState>(
    initialState,
