import { LOAD_EXECUTIONS_FAIL, LOAD_EXECUTIONS_REQUEST, LOAD_EXECUTIONS_SUCCESS, SELECT_EXECUTION, DESELECT_EXECUTION, CREATE_EXECUTION_REQUEST, CREATE_EXECUTION_FAIL, DELETE_EXECUTION_REQUEST, DELETE_EXECUTION_SUCCESS, DELETE_EXECUTION_FAIL, CLEAR_EXECUTIONS } from './spisok-kazney.actions';
